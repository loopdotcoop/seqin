...
this.steps=[];for(var u=0;u<(o.steps||16);u++)this.steps.push(new n(u,this));
...
return t.dump()}).join("+"):" "}},{},t)}(t.Slot)}(),!function(){var t=window.SEQIN=window.SEQIN||{};
t.Voice=$traceurRuntime.createClass(function(t){},{},{}),t.Buzz=function(t){
function i(){$traceurRuntime.superConstructor(i).apply(this,arguments);
}return $traceurRuntime.createClass(i,{},{},t)}(t.Voice),t.Noise=function(t){
function i(){$traceurRuntime.superConstructor(i).apply(this,arguments);
