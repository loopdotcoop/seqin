"use strict";!function(){var t=window.SEQIN=window.SEQIN||{};t.NAME="seqin",t.VERSION="0.0.15",
t.HOMEPAGE="http://seqin.loop.coop/";var i,e,s;t.Main=$traceurRuntime.createClass(function(r){
var o=this;i=t.Slot,e=t.TrackSlot,s=t.MasterSlot,this.ctx=new(window.AudioContext||window.webkitAudioContext),
this.worker=r.worker,this.fidelity=r.fidelity||5400,this.secsPerStep=r.fidelity/this.ctx.sampleRate,
this.notes=[],this.cbs={"*":[]},this.metronome="o",this.droppedTicks=0,this.duplicateTicks=0,
this.missedTicks=0,this.tracks=[];for(var u=0;u<(r.tracks||1);u++)this.tracks.push(new a(u,this));
...
this.worker.postMessage({action:"set-samplerate",value:this.ctx.sampleRate
}),this.worker.postMessage({action:"set-fidelity",value:this.fidelity
...
o.scheduleTick(s))}},{scheduleTick:function(t){var i=this,e=this.ctx.currentTime,s=e%this.secsPerStep,n=this.secsPerStep-s;
...
r[0]=t.velocity,r[1]=.5*t.velocity,n.text=.5<=t.velocity?"* ":"· ",s.masterSlot.mix();
...
for(var u=0;u<5400;u++)o[u]=Math.sin(u*n)/2;c.text=t.cycles+"",o[0]=.125,o[1]=.45,
o[2]=.125,o[3]=.25,o[4]=0,o[5]=.375,o[6]=0,o[7]=-.45,o[8]=.125,o[5399]=0,o[5398]=.25,
o[5397]=-.25,o[5396]=.25,o[5395]=-.25,o[5394]=.25,o[5393]=-.25,o[5392]=.25,o[5391]=-.25,
o[5390]=.25,o[5389]=-.25,o[5388]=.25,o[5387]=-.25,o[5386]=.25,o[5385]=-.25,o[5384]=.25,
a.masterSlot.mix(a.trackSlots.filter(function(t){return t.note}));
}}},t)}(t.Voice),t.Noise=function(t){function i(){$traceurRuntime.superConstructor(i).apply(this,arguments);
}return $traceurRuntime.createClass(i,{},{},t)}(t.Voice)}();